...
#define PMKFailingPromiseIndexKey @"BKFailingPromiseIndexKey"
#define PMKURLErrorFailingURLResponseKey @"BKURLErrorFailingURLResponseKey"
#define PMKURLErrorFailingDataKey @"BKURLErrorFailingDataKey"
#define PMKURLErrorFailingStringKey @"BKURLErrorFailingStringKey"
#define PMKJSONErrorJSONObjectKey @"BKJSONErrorJSONObjectKey"
#define PMKJoinPromisesKey @"BKJoinPromisesKey"
